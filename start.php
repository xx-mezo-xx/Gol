...
$edit = bot('sendMessage',[
    ...
    'reply_markup'=>json_encode([
            'inline_keyboard'=>[
                ...
                [['text'=>'NO Live ❌: '.$false,'callback_data'=>'dghkf']]
            ]
        ])
]);
$se = 100;
                    ...
                    if(checkMail($mail)){
                        ...
                        if ($inInsta !== false) {
                            // if($config['filter'] <= $follow){
                                ...
                                $following = $info['ff'];
                                $media = $info['m'];
                                bot('sendMessage', ['disable_web_page_preview' => true, 'chat_id' => $id, 'text' => "ĤÎŤĹÀŘ ĔĹŘÙŠĚ 𝅘𝅥𝅯࿐ 
๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛
.𖥂. user : [$usern](instagram.com/$usern)\n 
.𖥂. email : [$mail]\n 
.𖥂. followers  : $follow\n 
.𖥂. followers : $following\n 
.𖥂. post : $media\n
.𖥂. time : ".date("Y")."/".date("n")."/".date("d")." : " . date('g:i') . "\n" . " 
๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛๛
 [@QQ67QQ ๛ @QQ67QQQBOT ™]",
