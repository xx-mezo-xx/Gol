...
🔥 @QQ67QQ ☠️ @QQ67QQQBOT 👻',
                  ...
                  'reply_markup'=>json_encode([
                         'keyboard'=>[
                          ...
                          [['text'=>'اضغط هنا لتحميل الابتسامه🧡']],
                          [['text'=>'ĤÎŤĹÀŘ ĔĹŘÙŠĚ 𝅘𝅥𝅯™⸙ꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋꠋـ']],
                          [['text'=>'️فديو شرح اختراق المتاحات']],
                          [['text'=>'️برنامج توصيل الريست']],
                      ]
                  ])
              ]);   
		    ...
		    $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"اهلا بك في لوحة تحكمي يبروووووو💛 ⁦☃️⁩ @QQ67QQ",
                'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
               ...
               } if($text == 'اضغط هنا لتحميل الابتسامه🧡'){ 
            $bot->sendMessage([
		       'chat_id'=>$chatId,
                'message_id'=>$mid,
                'text'=>"جارى تحميل الابتسامه ال حياتك🙂١%█▒▒▒▒▒▒▒فشل التحميل يرجى اعده المحاوله",
...
bayou =~👻نونونونو ارتباط معنديش دماغ للبنات😂",

              ]);   
              
           } if($text == '️فديو شرح اختراق المتاحات'){
                  $bot->sendvideo([ 
                  'chat_id'=>$chatId,                  'video'=>"https://t.me/sorbrifjfj/7",

              ]);
              
              } if($text == '️برنامج توصيل الريست'){
                  $bot->sendvideo([ 
